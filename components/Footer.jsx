    ...
    <div class="md:px-12 lg:px-28">
        <div class="container m-auto space-y-6 text-gray-600">
            ...
            width={70}
              ...
              alt="Workflow"
             />
            <ul role="list" class="py-4 text-white flex flex-col gap-4 items-center justify-center sm:flex-row sm:gap-8">
